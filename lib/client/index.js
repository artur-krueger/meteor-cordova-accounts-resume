...
Meteor.startup(function () {
    if (Meteor.isCordova) {
        ...
        CordovaAccountsResume.handleLoginOnCordova();

        // handle app resumes
        CordovaAccountsResume.handleSessionResume();

    }
});

CordovaAccountsResume = {

    /**
     * This function supplements existing Meteor Accounts login functionality by storing the token in file storage
     */
    handleLoginOnCordova: function () {
